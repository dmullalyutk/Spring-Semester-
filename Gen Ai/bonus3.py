...
# Pipeline with temperature=0.5 (more focused/deterministic)
print("=" * 50)
...
# Pipeline with temperature=100.0 (very random)
print("\n" + "=" * 50)
...
# Analysis:
# Temperature = 0.5: Produces coherent, accurate translations. The model is confident
# and picks high-probability tokens, resulting in grammatically correct output.
#
