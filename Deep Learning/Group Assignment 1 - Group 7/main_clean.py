...
def transform_features(x_raw):
    """Log-shifted differences + hashed category one-hot + interactions."""
    ...
    return np.concatenate([numeric, cat_oh], axis=1)
...
def preprocess_x(x_raw, x_mean, x_std):
    """Transform, standardize, clip, and apply category scaling."""
